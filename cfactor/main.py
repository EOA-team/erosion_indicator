...
CONFIG = {
    ...
    'samples_s2_path':     'samples_data_grouped.pkl', # not generated if FC precomputed
    ...
    'fc_preds_path':       'samples_data_pred_grouped.pkl',
    ...
    'gapfilled_fc_path':    'samples_data_gpr_regular_grouped.parquet',
    'max_gap_days':         15,
    # Gapfilling method:
